...
namespace User
{
    class Validation
    {
        ...
        //        public bool IsCarditCard(string cc)
        //        {
        //            if (cc = "" || !IsNum(cc))
        //                return false;
        ...
        //                if (check == "one")
        //                {
        //                    c = Convert.ToInt32(cc.Substring(i, 1)) * 2;
        //                    check = "two";
        //                }
        //                else
        //                {
        //                    c = Convert.ToInt32(cc.Substring(i, 1));
        //                    check = "one";
        //                }
        //                if (c >= 10)
        //                {
        //                    tmp = c.ToString(); ;
        //                    result += Convert.ToInt32(tmp[0]) + Convert.ToInt32(tmp[1]);
        //                }
        //                else
        //                    result += c;
        //            }
